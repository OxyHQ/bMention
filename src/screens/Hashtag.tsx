...
const fakePosts = [
  {
    ...
    cid: 'fakeCid1',
    record: {},
    text: 'This is a fake post for testing purposes.',
    author: {
      did: 'did:example:123456789',
      handle: 'john.doe',
      displayName: 'John Doe',
    },
    indexedAt: '2023-10-01T12:00:00Z',
  },
]

const renderItem = ({ item }: ListRenderItemInfo<typeof fakePosts[0]>) => {
  return <Post post={item} />
}

const keyExtractor = (item: typeof fakePosts[0], index: number) => {
...
export default function HashtagScreen({
  ...
  const onShare = React.useCallback(() => {
    const url = new URL('https://mention.earth')
...
function HashtagScreenTab({
  ...
  const posts = React.useMemo(() => {
    return data?.pages.flatMap(page => page.posts) || fakePosts
  }, [data])
